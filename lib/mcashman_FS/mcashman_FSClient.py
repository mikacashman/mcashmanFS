...
class mcashman_FS(object):
    ...
    def FeatureSelection(self, params, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method FeatureSelection: argument json_rpc_context is not type dict as required.')
        resp = self._call('mcashman_FS.FeatureSelection',
