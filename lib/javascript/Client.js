...
function mcashman_FS(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.FeatureSelection = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax("mcashman_FS.FeatureSelection",
